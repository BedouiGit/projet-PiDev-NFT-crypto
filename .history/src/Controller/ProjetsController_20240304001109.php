...
use App\Entity\        $projets = $projetsRepository->findBy(['category' => $categoryId]);
;
...
class ProjetsController extends AbstractController
{
    ...
    public function index(ProjetsRepository $projetsRepository , Request $request , int $id): Response
    {
        ...
        $projet = $this->entityManager->getRepository(Project::class)->search($searchTerm, $sortField, $sortOrder , $currentPage, $perPage);
