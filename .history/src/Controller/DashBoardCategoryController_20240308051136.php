...
class DashBoardCategoryController extends AbstractController
{
    ...
    public function edit(Request $request, Category $category, EntityManagerInterface $entityManager , $id): Response
    {
    ...
    #[Route('/chart/projects_per_category', name: 'app_chart_projects_per_category')]
    public function projectsPerCategoryChart(CategoryRepository $categoryRepository): Response
    {
        $categories = $categoryRepository->findAll();
        $categoryProjectsCounts = [];

        foreach ($categories as $category) {
            $categoryProjectsCounts[$category->getName()] = count($category->getProjects());
        }
