...
class ProjetsController extends AbstractController
{
    ...
    public function index(ProjetsRepository $projetsRepository, EntityManagerInterface $entityManager , Request $request , int $id): Response
    {
        ...
        $projet = $this->entityManager->getRepository(Projets::class)->search(  $currentPage, $perPage);
        $projets = $projetsRepository->findBy(['category' => $categoryId]);
        $totalPeojects = count($projets);
        $totalPages = ceil($totalPeojects / $perPage);
